...
public class ReporteMedioDeTransporte
{
    ...
    public ReporteMedioDeTransporte(List<PersonaDTO> personas)
    {
    	...
    	try		{
			this.reporte = (JasperReport) JRLoader.loadObjectFromFile( "reportes" + File.separator + "ReporteMedioDeTransporte.jasper" );
		...
		{
			log.error("Ocurrió un error mientras se cargaba el archivo ReporteMedioDeTransporte.Jasper", ex);
		}
    }       
